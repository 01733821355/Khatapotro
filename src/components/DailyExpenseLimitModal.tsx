...
import { X, ShieldAlert, CheckCircle2, TrendingDown } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="1500"
                className="w-full pl-8 pr-4 py-2.5 text-base font-extrabold text-slate-900 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 disabled:opacity-50 disabled:bg-slate-100"
              />
            </div>
          </div>
